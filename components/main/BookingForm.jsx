				...
				{submitStatus === 'success' ? (
					...
					>
						<Icon
							...
							className="size-16 text-green-500 mb-4"
						/>
						<h2 className="text-2xl font-bold text-white mb-2">
							Booking Confirmed!
						</h2>
						<p className="text-white/80 max-w-sm">{submitMessage}</p>
					...
					// --- CHANGE: The form is now a motion component ---
					<motion.form
						key="form"
						onSubmit={handleSubmit}
						autoComplete="off"
						className="flex flex-col gap-5"
						exit={{ opacity: 0, y: -20 }} // <-- Animates out
