...
const Navbar = () => {
    ...
    // Helper to determine which page is active
    const isActive = (item) => {
    ...
    return (
        ...
        >
            ...
            <motion.a href="/" variants={itemVariants}>
                <img
                    src="/images/tedx-logo/logo-white.png"
            ...
            <ul className="hidden lg:flex gap-4 xl:gap-8 text-sm xl:text-md text-white/90">
                {navItems.map((item) => (
                    <motion.a
                        ...
                        className={`cursor-pointer transition-colors hover:text-white ${isActive(item) ? 'text-red-500 font-bold' : ''
                            }`}
                                ...
                                {navItems.map((item) => (
                                    <motion.li key={item} variants={mobileItemVariants}>
                                        <a
                                            ...
                                            className={`block py-3 px-4 rounded-lg text-lg transition-colors ${isActive(item)
