				...
				<div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
					...
					<div className="w-full h-full">
						...
						>
							...
							<span>
								<strong>NB:</strong> If your ticket type is a{' '}
								<strong>Student Ticket</strong>, please upload your{' '}
								<strong>valid student ID card</strong> during booking and don’t
								forget to bring it with you to the event.
							</span>
						</motion.div>
						<BookingForm />
					</div>
					...
					>
						...
						<Lanyard position={[0, 5, 25]} fov={25} transparent={true} />
					</motion.div>
				</div>
			</section>
